...
package java.kafka.consumer;

import java.io.Serializable;
import java.kafka.DynamicPartitionConnections;
import java.kafka.FailedFetchException;
import java.kafka.KafkaConfig;
import java.kafka.PartitionCoordinator;
import java.kafka.PartitionManager;
import java.kafka.ZkBrokerReader;
import java.kafka.ZkCoordinator;
import java.kafka.ZkState;
...
public final class KafkaConsumer implements Runnable, Serializable {
